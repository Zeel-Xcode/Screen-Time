...
/**
 * Created by intel on 01-12-2017.
 */

public class AppConstant {

    public static final String FB_TIME = "0:55";
    public static final String FB_ATIME = "FB_ATIME";
    public static final String INSTA_TIME = "0:30";
    public static final String INSTA_ATIME = "INSTA_ATIME";
    public static final String SNAPCHAT_TIME = "0:40";
    public static final String SNAPCHAT_ATIME = "SNAPCHAT_ATIME";
    public static final String CURRENT_DATE = "CURRENT_DATE";
    public static final String FBAVERAGE_COUNT = "FBAVERAGE_COUNT";
    public static final String INSTAAVERAGE_COUNT = "INSTAAVERAGE_COUNT";
    public static final String SNAPAVERAGE_COUNT = "SNAPAVERAGE_COUNT";
